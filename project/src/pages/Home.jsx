...
export default function Home() {
    ...
    return (
        <div className={styles.homePage}>
          <div>
            <img src={valorant_home_page_image} alt="valorant_home_page_image"  width={950} height={600} />
          </div>
          <div className={styles.cardGrid}><CardGridView data={CARD_DATA}></CardGridView></div>
        </div>
    );
}
